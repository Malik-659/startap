...
const LoginPage = () => {
  return (
    <div className="star-body">
      <div className="absolute z-[1000] w-full h-full mx-auto">
        <Login />
      </div>
      <section className="star-wars">
          ...
          <div class="at-at-content">
            <div class="at-at-body">
              ...
              <div class="at-at-body-bottom">
                <div class="at-at-body-bottom-bg">
                  <i></i>
                  <i></i>
                  <i></i>
                </div>
          ...
          <div class="leg-content leg-front">
            ...
            <div class="leg-first">
              ...
              <div class="in-first-leg">
                <div class="leg-second-joint">
                  <i></i>
                </div>
                <div class="leg-second">
                  <i class="leg-second-hr"></i>
                  <div class="in-second-leg">
                    <div class="foot-joint">
                      <i class="foot-ankle">
                        <i class="foot-ankle-bg"></i>
                      </i>
                    </div>
        ...
        <div class="space-ship space-ship-small">
          ...
          <i class="space-ship-bg">
            <i class="space-ship-gun"></i>
          </i>
        </div>
